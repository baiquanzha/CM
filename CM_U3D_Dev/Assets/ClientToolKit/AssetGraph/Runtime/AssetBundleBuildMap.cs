...
namespace UnityEngine.AssetGraph
{
    ...
    public class AssetBundleBuildMap : ScriptableObject
    {
        ...
        {
            private const string PREFKEY_AB_BUILDMAP_PATH = "MTool.AssetGraph.BuildMapPath";
            ...
            public static string AssetBundleBuildMapPath
            {
                get
                {
                    ...
                    {
                        return Path.Combine("Assets/GamePackageRes/AssetGraph/Cache/", "AssetBundleBuildMap.asset");
                    }
