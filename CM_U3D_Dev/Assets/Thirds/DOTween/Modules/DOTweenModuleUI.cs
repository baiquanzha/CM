...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        public static TweenerCore<int, int, NoOptions> DOCounter(
            this Text target, int fromValue, int endValue, float duration, bool addThousandsSeparator = true, CultureInfo culture = null, string formatStr = null
        ){
            int v = fromValue;
            ...
            TweenerCore<int, int, NoOptions> t = DOTween.To(() => v, x => {
                ...
                {
                    target.text = string.Format(formatStr, addThousandsSeparator
                        ? v.ToString("N0", cInfo)
                        : v.ToString());
                }
            }, endValue, duration);
