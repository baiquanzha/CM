...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static void RegisterBaseImporters ()
        {
            ...
            // 拓展;
            RegisterImporter<int, string>((int input) => { return input.ToString(); });
            RegisterImporter<string, int>((string input) => { return Convert.ToInt32(input); });
        }
                                        ...
                                        int depth)
        {
            ...
            if (obj is object[])
            {
                ...
                foreach (object elem in (object[])obj)
                    WriteValue(elem, writer, writer_is_private, depth + 1);
